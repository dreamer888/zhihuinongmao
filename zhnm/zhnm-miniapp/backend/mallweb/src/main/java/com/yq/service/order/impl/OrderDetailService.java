...
public class OrderDetailService implements OrderDetailManager {
	 ...
	 * @throws Exception
	 */
	public PageData printOrder(PageData pd) throws Exception {
		return (PageData) dao.findForObject("OrderDetailMapper.printOrder", pd);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<PageData> printOrderDetail(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("OrderDetailMapper.printOrderDetail", pd); 
	}
