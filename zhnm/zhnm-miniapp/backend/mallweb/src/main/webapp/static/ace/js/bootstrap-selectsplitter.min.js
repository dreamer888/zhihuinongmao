...
function(e) {
    ...
    function t(t) {
        return this.each(function() {
            ...
            o = "object" == typeof t && t; (s || "destroy" != t) && (s || l.data("selectsplitter", s = new r(this, o)), "string" == typeof t && s[t]())
        })
    }
    var r = function(e, t) {
    ...
    r.DEFAULTS = {
        template: '<div class="row" data-selectsplitter-wrapper-selector><div class="col-xs-12 col-sm-6"><select class="form-control" id="select-1" data-selectsplitter-firstselect-selector style="height:120px"></select></div> <!-- Add the extra clearfix for only the required viewport --><div class="clearfix visible-xs-block"></div><div class="col-xs-12 col-sm-6"><select class="form-control" id="select-2" data-selectsplitter-secondselect-selector id="selected" onclick="showselect()" style="height:120px"></select></div></div>'
    },
    r.prototype.init = function(t, l, s) {
        ...
        o.$element.find("optgroup").each(function() {
            ...
            e(this).find("option").each(function() {
                o.fullCategoryList[t.attr("label")][e(this).attr("value")] = e(this).text(),
                r++
            }),
            r > n && (n = r),
            a++
        ...
        var i = "";
        for (var c in o.fullCategoryList) o.fullCategoryList.hasOwnProperty(c) && (i = i + "<option>" + c + "</option>");
        ...
        var p = Math.max(a, n);
        p = Math.min(p, 10),
        o.options.selectSize && (p = o.options.selectSize),
        o.$firstSelect.attr("size", p),
        o.$secondSelect.attr("size", p),
        ...
        o.$element.find("option[selected=selected]").length && (o.$selectedOption = o.$element.find("option[selected=selected]"), o.currentParentCategory = o.$selectedOption.closest("optgroup").attr("label"), o.currentChildCategory = o.$selectedOption.attr("value"), o.$firstSelect.find("option:contains(" + o.currentParentCategory + ")").attr("selected", "selected"), o.$firstSelect.trigger("change"))
    },
    r.prototype.updateParentCategory = function() {
        ...
        var t = "";
        for (var r in e.fullCategoryList[e.currentParentCategory]) e.fullCategoryList[e.currentParentCategory].hasOwnProperty(r) && (t = t + '<option value="' + r + '">' + e.fullCategoryList[e.currentParentCategory][r] + "</option>");
