            ...
            var order_id = '<%=order_id%>';
	     	...
	     	function loadList(order_id){
				...
				$.ajax(
				{
			  		async: false,
			      	type:'POST',
			      	url: "<%=basePath%>login_printOfflineOrder",
			  		cache:false,
			  		dataType: 'json',
			  		data:param,
			  		success: function(data)
			  		{
			  			    ...
			  			    var payInfoHtml = "";
			  			    payInfoHtml +=  "<label>订单编号："+payInfo.order_number+"</label>";
							...
							if(orderDetailArr.length>0){
							   for(var i=0;i<orderDetailArr.length;i++){  
								   ...
								   orderDetailHtml += "<td>"+orderDetailArr[i].PAY_TOTAL+"</td>";
