...
@Service
public class CcbOnePointPayPerformance {

	private static final Logger logger = LoggerFactory.getLogger(CcbOnePointPayPerformance.class);
    ...
    public WechatQRCodeGenerateResponseToClient doQRcodeOrder(BalanceOfflineOrder balanceOfflineOrder,SellerBankAccount account){
    	logger.info("CcbOnePointPayPerformance-->orderId:"+balanceOfflineOrder.getId());
        ...
        logger.info("CcbOnePointPayPerformance-->PUB32TR2:"+PUB32TR2);
