								...
								<form action="balance/${msg }.do" name="balanceForm" id="balanceForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<tr>
											...
											<td><input type="text" name="IMEI" id="IMEI" value="${pd.IMEI }" maxlength="32" placeholder="这里输入IMEI号" title="IMEI号" onblur="hasIMEI('${pd.IMEI }')" style="width:98%;"/></td>
										</tr>
										...
										<tr>
											...
											<td>
											<select style="width:98%;"  name="USED" id="USED">
											<option>使用</option>
											<option>未使用</option>
											</select>
											</td>
